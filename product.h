...
void savaData(Product * p[], int count); //file에 저장하는 함수
...
void searchWeight(Product * p[], int count, int s_price); //가격을 검색하는 함수 (예 : 얼마 미만인 제품)
void searchStar(Product * p[], int count, int s_star);   //별점을 검색하는 함수 (예 : 별점 몇 개 이상인 제품)
